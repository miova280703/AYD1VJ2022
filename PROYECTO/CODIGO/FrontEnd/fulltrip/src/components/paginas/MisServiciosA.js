...
export default function MisServiciosAgencia() {
    ...
    const [marcaEditarState, setMarcaEditarState] = useState("");
    const [modeloEditarState, setMoodeloEditarState] = useState("");
    const [placaEditarState, setPlacaEditarState] = useState("");
    ...
    const RECIBIR_URL = `http://34.125.201.105:4000/v1/fullTrip/AutosXservicio`
    const RECIBIR_URL1 = `http://localhost:4000/v1/fullTrip/AutosXservicio`
    ...
    const EDITARC_URL = `http://34.125.201.105:4000/v1/fullTrip/UpdateAutomovil`
    const EDITARC_URL1 = `http://localhost:4000/v1/fullTrip/UpdateAutomovil`
    async function Editar(n, m) {
        console.log("carro a editar: " + n + " " + m);
        handleOpen1()
        setIdEditarState(n);
        setMarcaEditarState(filasTablaState[m].Marca);
        setMoodeloEditarState(filasTablaState[m].Modelo);
        setPlacaEditarState(filasTablaState[m].Placa);
        setPrecioEditarState(filasTablaState[m].Precio);
        const fecha = filasTablaState[m].FechaDisponible.split(":")
    ...
    async function GuardarEditar() {
        ...
        axios.put(EDITARC_URL1, {
            IdAutomovil: idEditarState,
            Marca: marcaEditarState,
            Placa: placaEditarState,
            Modelo: modeloEditarState,
    ...
    const ELIMINAR_URL = `http://34.125.201.105:4000/v1/fullTrip/DeleteAutomovil`
    const ELIMINAR_URL1 = `http://localhost:4000/v1/fullTrip/DeleteAutomovil`
    ...
    const CREARAUTO_URL = `http://34.125.201.105:4000/v1/fullTrip/CreateAutomovil`
    const CREARAUTO_URL1 = `http://localhost:4000/v1/fullTrip/CreateAutomovil`
    ...
    return (
        <>
            ...
            <Box style={{ position: 'absolute', top: '25%', left: '15%', width: "1250px", height: "1000px" }}>
                    ...
                    <Table sx={{ minWidth: 700 }} aria-label="customized table" responsive>
                        ...
                        <TableBody>
                            {filasTablaState.map((row, numero) => {
                                const im = '"' + row.img + '"'
                                return (
                                    <StyledTableRow key={row.Id_Auto} >
                                        ...
                                        <StyledTableCell component="th" scope="row" align="center" >
                                            <Button variant="outlined" color="secondary" onClick={() => Editar(row.Id_Auto, numero)}>
                                                <EditIcon />EDITAR
                                            </Button> &nbsp;
                                            <Button variant="outlined" color="secondary" onClick={() => Eliminar(row.Id_Auto)}>
                ...
                >
                    <Box sx={{ ...style, width: 400 }}>
                    <h2 id="child-modal-title">EDITAR AUTOMOVIL </h2>
                        <br />
                        ...
                        >
                            ...
                            <TextField
                                ...
                                variant="standard"
                                onChange={event => setMarcaEditarState(event.target.value)}
                            // ref={inputNombre}
                            />
                        </Box>
                        <br />
                        ...
                        >
                            ...
                            <TextField
                                ...
                                label="Ingrese Modelo del Automovil:"
                                placeholder="Sentra"
                                defaultValue={modeloEditarState}
                                InputProps={{
                                    startAdornment: (
                                        <InputAdornment position="start">
                                            {/* <AccountBoxIcon /> */}
                                ...
                                variant="standard"
                                onChange={event => setMoodeloEditarState(event.target.value)}
                            // ref={inputNombre}
                            />
                        </Box>
                        <br />
                        ...
                        >
                            ...
                            <TextField
                                ...
                                variant="standard"
                                onChange={event => setPlacaEditarState(event.target.value)}
                            // ref={inputNombre}
                            />
                        </Box>
                        <br />
                        ...
                        >
                            ...
                            <FormControl fullWidth>
                                <InputLabel id="demo-simple-select-label">Selecciona Estado Auomovil:</InputLabel>
                                <Select
                                    labelId="demo-simple-select-label"
                                    id="demo-simple-select"
                                    value={estadoEditarState}
                                    label="Selecciona Estado Auomovil:"
