...
class Ruta1 extends React.Component{
    ...
    handleSubmit = async e =>{
        ...
        const res = await fetch(`http://localhost:3000/PAROIMPAR/${numero}`)
    ...
    render(){
        return(
            <div className="main-container col-12" align = "Center">
                <h1>Detectar Número Par o Impar</h1>
                <h3>Ingrese el Numero</h3>                               
                <Form onSubmit ={this.handleSubmit}>
                    <FormGroup controlId="formUsername">
                        <FormControl type="text" name="Username" placeholder="Ingrese Usuario" onChange={this.handleChange} value={this.state.form.Username}/>
                    </FormGroup>
                </Form>
                <h2>El resultado es: {this.state.resultado} </h2>
                <h1> </h1>
